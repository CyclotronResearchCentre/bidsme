...
def user_data_dir(appname, appauthor=None, version=None, roaming=False):
    ...
    Typical user data directories are:
        ...
        Win XP (roaming):       C:\\Documents and Settings\\<username>
...
def site_data_dir(appname, appauthor=None, version=None):
    ...
    Typical user data directories are:
        ...
        Win XP:     C:\\Documents and Settings\\All Users\\
                    Application Data\\<AppAuthor>\\<AppName>
        Vista:      (Fail! "C:\\ProgramData" is a hidden
                    *system* directory on Vista.)
...
def user_cache_dir(appname, appauthor=None, version=None, opinion=True):
    ...
    Typical user cache directories are:
        ...
        Win XP:     C:\\Documents and Settings\\<username>\\Local Settings\\
                    Application Data\\<AppAuthor>\\<AppName>\\Cache
        Vista:      C:\\Users\\<username>\\AppData\\Local\\
                    <AppAuthor>\\<AppName>\\Cache

    On Windows the only suggestion in the MSDN docs is that local settings
    go in the `CSIDL_LOCAL_APPDATA` directory. This is identical to
    the non-roaming app data dir (the default returned by `user_data_dir`
    above). Apps typically put cache data somewhere *under* the given
    dir here. Some examples:
...
def user_log_dir(appname, appauthor=None, version=None, opinion=True):
    ...
    Typical user cache directories are:
        ...
        Win XP:     C:\\Documents and Settings\\<username>\\Local Settings\\
                    Application Data\\<AppAuthor>\\<AppName>\\Logs
        Vista:      C:\\Users\\<username>\\AppData\\Local\\
                    <AppAuthor>\\<AppName>\\Logs
