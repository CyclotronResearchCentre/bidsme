...
metafields = {
        "Unknown": {
            ...
            "ReceiveCoilActiveElements": ("<ReceiveCoilActiveElements>", None),
            "MRTransmitCoilSequence": ("<MRTransmitCoilSequence>", None),
            ...
            "PartialFourier": ("<PartialFourier>", None),
            "PartialFourierDirection": ("<PartialFourierDirection>", None),
            "EchoTime": ("<scale-3:EchoTime>", None),
            "InversionTime": ("<scale-3:InversionTime>", None),
            "FlipAngle": ("<FlipAngle>", None),
            "InstitutionName": ("<InstitutionName>", None),
            "InstitutionAddress": ("<InstitutionAddress>", None),
            "InstitutionalDepartmentName": ("<InstitutionalDepartmentName>", None),
